		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creation of Users in SAP",
									"targetURL": "#uidemoappdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uidemoappdemoapp-display": {
								"semanticObject": "uidemoappdemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.demoapp.demoapp",
									"url": sap.ui.require.toUrl("ui/demoapp/demoapp")
								}
							}
						}
					}
